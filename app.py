...
def load_questions() -> list:
    ...
    embedded: list = [
        ...
        {"q":"How frequently do you feel thirsty throughout the day?",
         "opts":[["Never (well hydrated)",0],["Rarely",1],["Sometimes",2],["Often",3],["Always",4]]},
        ...
        {"q":"How consistent is your hydration routine throughout the week?",
         "opts":[["Very consistent",0],["Mostly consistent",1],["Somewhat consistent",2],["Inconsistent",3],["No routine",4]]},
